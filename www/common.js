...
/***/ "./src/app/api/beneficiary/beneficiary.service.ts":
/*!********************************************************!*\
  !*** ./src/app/api/beneficiary/beneficiary.service.ts ***!
  \********************************************************/
...
/* harmony import */ var _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../constants/test.enum */ "./src/app/api/constants/test.enum.ts");
/* harmony import */ var _constants_public__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../constants/public */ "./src/app/api/constants/public.ts");
...
var BeneficiaryService = /** @class */ (function () {
    ...
    BeneficiaryService.prototype.handleError = function (operation, result) {
        ...
        return function (error) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])("Some error occured. Please try again");
        };
    };
    BeneficiaryService.prototype.addBeneficiary = function (postData) {
        var _this = this;
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "addBeneficiary", postData, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("AddBeneficiary", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("addBeneficiary"); }));
    };
    BeneficiaryService.prototype.getPurposeList = function () {
        var _this = this;
        return this.http
            .post(_constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].BASE_URL + "getPurposeCodeList", {}, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) {
            console.log("PurposeList", res);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("getPurposeCodeList"); }));
    };
    BeneficiaryService.prototype.getSourceOfFundsList = function () {
        var _this = this;
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "getSourceOfFundList", {}, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("SourceOfFunds", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("sourceOfFunds"); }));
    };
    BeneficiaryService.prototype.getRelationList = function () {
        var _this = this;
        return this.http
            .post(_constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].BASE_URL + "getRelationsList", {}, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("RelationList", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("getRelationList"); }));
    };
    BeneficiaryService.prototype.getNationalityList = function () {
        var _this = this;
        return this.http
            .post(_constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].BASE_URL + "getNationalityList", {}, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_public__WEBPACK_IMPORTED_MODULE_6__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("GetNationality", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("getNationalityList"); }));
    };
    BeneficiaryService.prototype.getBeneficiaryListByFilter = function (userId, token, filter) {
        var postData = {
            UserID: userId,
            SessionToken: token,
            SortOrder: filter,
        ...
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "getBeneficiaryList", postData, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("getBeneficiaryList", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("getBeneficiaryList")));
    };
    BeneficiaryService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/api/getDaysRate/get-days-rate.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/api/getDaysRate/get-days-rate.service.ts ***!
  \**********************************************************/
/*! exports provided: GetDaysRateService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GetDaysRateService", function() { return GetDaysRateService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _constants_public__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../constants/public */ "./src/app/api/constants/public.ts");
...
var GetDaysRateService = /** @class */ (function () {
    function GetDaysRateService(http) {
        this.http = http;
    }
    GetDaysRateService.prototype.handleError = function (operation, result) {
        if (operation === void 0) { operation = "operation"; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
            console.error(error); // log to console instead
    ...
    GetDaysRateService.prototype.getDaysRate = function () {
        var _this = this;
        return this.http
            .post(_constants_public__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "GetDaysRate", {}, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_public__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("GetDaysRate", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("GetDaysRate"); }));
    };
    GetDaysRateService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: "root",
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])
    ], GetDaysRateService);
    return GetDaysRateService;
}());
...
/***/ "./src/app/api/transaction/transaction.service.ts":
/*!********************************************************!*\
  !*** ./src/app/api/transaction/transaction.service.ts ***!
  \********************************************************/
...
var TransactionService = /** @class */ (function () {
    ...
    TransactionService.prototype.getTransRate = function (postData) {
        var _this = this;
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "getTransRate", postData, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("getTransRate", res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError("getTransRate"); }));
    };
    TransactionService.prototype.sendAmount = function (postData) {
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "sendAmount", postData, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return console.log("Send Amonut", res); }));
    };
...
/***/ "./src/app/api/transactionList/transaction-list.service.ts":
/*!*****************************************************************!*\
  !*** ./src/app/api/transactionList/transaction-list.service.ts ***!
  \*****************************************************************/
/*! exports provided: TransactionListService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransactionListService", function() { return TransactionListService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var TransactionListService = /** @class */ (function () {
    function TransactionListService(http) {
        this.http = http;
    }
    TransactionListService.prototype.handleError = function (operation, result) {
        if (operation === void 0) { operation = "operation"; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
            console.error(error); // log to console instead
    ...
    TransactionListService.prototype.getTransListWithFilter = function (userId, token, filter, transactionNo) {
        var postData;
        if (transactionNo) {
            postData = {
                UserID: userId,
        ...
        return this.http
            .post(_constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].BASE_URL + "getTransHist", postData, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _constants_test_enum__WEBPACK_IMPORTED_MODULE_5__["default"].HEADERS, { withCredentials: true }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) { return console.log(res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("5 Translist")));
    };
    TransactionListService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: "root",
        }),
...
/***/ "./src/app/models/trans-list-filter.enum.ts":
/*!**************************************************!*\
  !*** ./src/app/models/trans-list-filter.enum.ts ***!
  \**************************************************/
/*! exports provided: TransListFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransListFilter", function() { return TransListFilter; });
var TransListFilter;
(function (TransListFilter) {
    TransListFilter["BENEFICIARY"] = "BENEFICIARY";
    TransListFilter["TX_DATE"] = "TX_DATE";
    TransListFilter["TX_FC"] = "TX_FC";
    TransListFilter["TX_KD"] = "TX_KD";
    TransListFilter["TX_NUMBER"] = "TX_NUMBER";
})(TransListFilter || (TransListFilter = {}));
